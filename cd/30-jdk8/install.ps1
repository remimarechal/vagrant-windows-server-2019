...
function Main {
    ...
    Add-ToUserPath "C:\Program Files\Java\jdk1.8.0_202\bin"

    [Environment]::SetEnvironmentVariable("JDK_HOME", "C:\Program Files\Java\jdk1.8.0_202", [EnvironmentVariableTarget]::User)
    [Environment]::SetEnvironmentVariable("JAVA_HOME", "C:\Program Files\Java\jdk1.8.0_202", [EnvironmentVariableTarget]::User)
}
